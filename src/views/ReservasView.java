...
//	}
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if ((txtFechaEntrada.getDate() != null && compararFechaActual()) && txtFechaSalida.getDate() != null) {
					calcularValor();
				}
			}
		});
	...
	private void calcularValor() {
		...
		if (salida.isAfter(entrada)) {
			...
			JOptionPane.showMessageDialog(null, "La fecha de check-out debe ser mayor a la fecha de check-in.");
		}
	}
